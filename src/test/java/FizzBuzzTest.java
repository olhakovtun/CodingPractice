...
public class FizzBuzzTest {
    ...
    public void testFizzBuzzHappyPath() {
       ...
       int startNumber = 1;
       int endNumber = 100;
        List<String> expectedValues = List.of("1", "2", "Fizz", "4", "Buzz", "Fizz", "7", "8", "Fizz", "Buzz", "11",
        ...
        List<String> actualResult = fizzBuzz.fizzBuzzList(startNumber, endNumber);

        Assert.assertEquals(expectedValues, actualResult);
    }
}
